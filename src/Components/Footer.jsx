  ...
  return (
    <>
      <div className="w-full flex flex-col items-center justify-center py-20">
        ...
        <p className="text-xs text-black/70 mt-2">Leading the way in cutting-edge technology and innovation.</p>

        <div className="border border-black/10 w-[85%] my-4"></div>

        <div className="grid grid-cols-3 mt-3 gap-32 text-[#09080F]/60">
